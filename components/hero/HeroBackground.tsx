...
export default function HeroBackground() {
  return (
    <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
      ...
      <div className="hero-background-orb-a absolute -left-[8%] top-[4%] h-[24rem] w-[24rem] rounded-full bg-[radial-gradient(circle,rgba(22,163,74,0.09),transparent_70%)] opacity-35 blur-[74px] light:opacity-15" />
      <div className="hero-background-orb-b absolute right-[8%] top-[13%] h-[28rem] w-[28rem] rounded-full bg-[radial-gradient(circle,rgba(22,163,74,0.08),transparent_68%)] opacity-35 blur-[88px] light:opacity-15" />
