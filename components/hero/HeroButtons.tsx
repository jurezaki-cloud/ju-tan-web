...
export default function HeroButtons() {
  return (
    <div className="mt-4 flex flex-wrap gap-3">
      <Link
        href="#contact"
        className={`group inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-green-600 to-green-500 px-6 py-3 font-semibold text-white shadow-lg shadow-green-600/30 hover:shadow-xl hover:shadow-green-500/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-400 ${buttonTransition}`}
      >
        Brezplačen posvet
      ...
      <Link
        href="#projects"
        className={`group inline-flex items-center gap-2 rounded-xl border border-white/15 bg-white/5 px-6 py-3 font-semibold text-white shadow-md shadow-black/20 backdrop-blur-sm hover:border-green-500/50 hover:bg-white/10 hover:shadow-lg hover:shadow-green-500/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-400 ${buttonTransition}`}
      >
        Oglej si projekte
        <FolderOpen
